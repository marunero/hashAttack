...
os.system('python main.py -i 0 -n 1 -mu 8 -ti 0 --gpu 0 -mc 16 --targeted -hash phash256 -dist l2dist --optimizer momentum --use_grayscale --use_resize --resize_size 64 --batch 1 -lr 0.01 -mi 20000 -pc 64 --save result --seed 25146')

os.system('python main.py -i 0 -n 1 -mu 12 -ti 0 --gpu 0 -mc 10 --targeted -hash phash256 -dist l2dist --optimizer momentum --use_grayscale --use_resize --resize_size 64 --batch 1 -lr 0.01 -mi 20000 -pc 64 --save result --seed 25146')

os.system('python main.py -i 0 -n 1 -mu 20 -ti 0 --gpu 0 -mc 6 --targeted -hash phash256 -dist l2dist --optimizer momentum --use_grayscale --use_resize --resize_size 64 --batch 1 -lr 0.01 -mi 20000 -pc 64 --save result --seed 25146')
